...
namespace ConsoleApplication
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine(array2D[0,1]); //prints 0 because as no value is declared for that.
            Console.WriteLine(array3D[1,0,3]); //prints 42.. goes to 1 index of main array and then zero index of subarray in that 3rd index
            Console.WriteLine("*******");
